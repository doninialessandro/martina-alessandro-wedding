    ...
    <section className="px-8 pt-8 pb-20 sm:px-12 md:pb-24 md:px-16">
      <div className="mx-auto max-w-[1100px]">
        <ScrollReveal translateY={18} start={0} end={0.35} effect="slide">
          <h2 className="mb-20 font-serif text-accent text-sm uppercase tracking-[0.3em] text-center md:mb-24">
            {copy.sectionTitle}
          </h2>
        </ScrollReveal>
        ...
        <div className="max-w-[800px] mx-auto text-center">
          <ScrollReveal translateY={10} start={0.05} end={0.4} offset={0.1} effect="slide">
            <p className="select-text font-serif text-muted-foreground text-base tracking-[0.05em] md:text-lg">
              {copy.body}
              <br />
              <br />
