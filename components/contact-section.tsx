...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={ref} className="py-24 md:py-40 px-8 sm:px-12 md:px-16">
      <div className="max-w-2xl mx-auto">
        <h2
          className={`text-3xl md:text-5xl font-serif font-normal text-[#1A1A1A] mb-4 text-center transition-all duration-[1000ms] ease-out ${
        ...
        <p
          className={`text-base md:text-lg text-[#6B6B6B] font-serif text-center mb-14 transition-all duration-[1000ms] ease-out delay-200 ${
        ...
        {submitted ? (
          ...
          <form
            ...
            className={`space-y-8 transition-all duration-[1000ms] ease-out delay-300 ${
              isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
