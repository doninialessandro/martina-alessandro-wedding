      ...
      <ScrollReveal translateY={30} start={0} end={0.35}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-10">
            {/* Twitter/X */}
            <a
              href="https://twitter.com/intent/tweet?url=https://www.solomei.ai"
              target="_blank"
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/sharer/sharer.php?u=https://www.solomei.ai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#1A1A1A] hover:opacity-60 transition-opacity"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.solomei.ai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#1A1A1A] hover:opacity-60 transition-opacity"
